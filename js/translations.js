...
const translations = {
  en: {
    ...
    // USP Banner
    'usp.item1': 'No app to install',
    'usp.item2': 'Ready in 1 day',
    'usp.item3': '€49 for 30 days',

    // Hero Section
    'hero.title': 'Know your week before it starts',
    'hero.subtitle': 'You already check the weather. Now see what it means for your prep, your orders, and your staff.',
    ...
    'hero.demo': 'View demo',
    'hero.trust': 'No app to install · No subscription · Ready in 1 day · €49 for 30 days',
    ...
    'problem.conclusion': 'Your experience already gives you a strong feel for demand. We just put numbers on top of that instinct — so you can plan with confidence instead of guesswork.',
    'problem.cta': 'See how it works',

    // How It Works Section
    'how.title': 'How you get it (no tech skills needed)',
    'how.subtitle': 'You send us your sales history. We build your forecast. That\'s it.',
    'how.step1.title': 'Send us a sales export',
    'how.step1.text': 'Export your sales from your POS — usually just a few clicks. If you get stuck, we\'ll help you through it.',
    'how.step2.title': 'We build your forecast',
    'how.step2.text': 'We combine your sales history with weather patterns to create a forecast tailored to your restaurant.',
    'how.step3.title': 'Check it like the weather',
    'how.step3.text': 'You get a link and password to your private website. Open it each morning, see your week ahead — 30 seconds and you\'re done.',

    // Features Section
    'features.title': 'What you\'ll see each day',
    'features.category1.title': 'Plan your prep',
    'features.category2.title': 'No hassle',
    'features.item1.title': 'Portions to prep, item by item',
    'features.item1.text': 'See how many of each dish to prepare — for today, tomorrow, and the whole week ahead.',
    'features.item2.title': 'Your patterns = Your numbers',
    'features.item2.text': 'We learn how YOUR restaurant responds to weather — your rainy Saturdays, your sunny terraces, your quiet Mondays.',
    'features.item3.title': 'Always see the week ahead',
    'features.item3.text': 'Today plus the next 6 days, updated every morning. Plan your ordering, staffing, and prep in one glance.',
    'features.item4.title': 'Quiet day or busy one?',
    'features.item4.text': 'Highlighted cells show when a day looks different from your typical Tuesday, Saturday, or any other day. Scale up or scale down at a glance.',
    'features.item5.title': 'Share with your team',
    'features.item5.text': 'Download the week as a simple file and share it with your kitchen, bar staff, or suppliers. Everyone can plan together.',
    'features.item6.title': 'Try it. If it doesn\'t help, stop.',
    'features.item6.text': 'Pay €49 for 30 days. It stops automatically — no subscription, no cancellation needed. Continue only if it\'s useful.',
    'features.item7.title': 'Holidays and events built in',
    'features.item7.text': 'Public holidays, local festivals, cruise arrivals — we can add what matters for your business, so you don\'t have to remember.',
    'features.cta': 'Get started for €49',

    // ROI Section
    'roi.title': 'The math is simple',
    'roi.subtitle': 'Most restaurants waste more than €49 a month on over-ordering alone. Here\'s where you save.',
    'roi.stat1.number': '€300–600/month',
    'roi.stat1.title': 'less food waste',
    'roi.stat1.text': 'Prep what you\'ll actually sell. Less spoilage, less over-ordering. On a typical €3,000 food spend, that\'s real money back in your pocket.',
    'roi.stat2.number': 'Staff smarter',
    'roi.stat2.title': 'not harder',
    'roi.stat2.text': 'Know when to call in extra hands and when to send someone home early. No more overstaffing slow days or scrambling on busy ones.',
    'roi.stat3.number': 'Never 86 again',
    'roi.stat3.title': 'on a busy day',
    'roi.stat3.text': 'Know ahead of time when you\'ll need extra stock. No more running out of best-sellers when the terrace is full.',
    'roi.exampleLabel': 'Bottom line',
    'roi.example': 'If you throw away €50 of food a week, you\'re losing €200 a month. The €49 for deitalite pays for itself the first week you use it.',
    ...
    'pricing.feature1': '✓ See portions to prep, item by item',
    'pricing.feature2': '✓ Weather checked automatically',
    'pricing.feature3': '✓ Your own private website',
    'pricing.feature5': '✓ 1-day onboarding setup',
    'pricing.cta': 'Get started for €49',
    ...
    'faq.q2.answer': 'In practice, most restaurants simply check their forecast once a day or a few times a week. You look at the next 7 days, see how busy each day is expected to be compared to your usual days and then adjust your prep, ordering and staff planning accordingly. It is designed to be a quick check before you make your decisions, not another system you need to manage.',
    'faq.q3.question': 'How long does setup take?',
    'faq.q3.answer': 'Setup takes one business day. Once you have exported your sales data and sent it to us, we prepare your personal forecast and send you a link and password within one business day.',
    ...
    'faq.q12.question': 'Does the forecast include drinks?',
    'faq.q12.answer': 'Currently, the forecast focuses on food items. We are working on adding drink forecasting and expect to launch this in early 2026.',
    ...
    'start.hero.subtitle': 'Pay a one-time fee of €49, send us your sales data, and get your personal forecast within one business day. No subscription, no lock-in.',
    ...
    'start.what.item1': '30 days of access to your private forecast website.',
    'start.what.item2': '7-day forecast that updates daily with weather.',
    'start.what.item3': 'Portions to prep, item by item, so you can plan with confidence.',
    ...
    'start.need.item3': 'An email address where we can send your link and password.',
    ...
    'start.steps.step3.title': 'Your forecast is ready',
    'start.steps.step3.text': 'Within one business day, we prepare your forecast and email you a link and password so you can start planning.',
    ...
    // Final CTA Section
    'cta.title': 'Know your week before it starts',
    'cta.subtitle': 'Send us your sales history. We\'ll have your forecast ready in one day.',
    'cta.button': 'Get started for €49',
    'cta.urgency': 'Limited time offer',

    // Footer
    'footer.tagline': 'Know your week before it starts',
    'footer.links': 'Links',
    ...
    'footer.cta.title': 'Ready to know your week ahead?',
    'footer.cta.button': 'Get started for €49',
  ...
  es: {
    ...
    'problem.conclusion': 'Tu experiencia ya te da una buena intuición de la demanda. Un pronóstico basado en el tiempo ayuda a pone cifras a esa intuición, para que puedas planificar comensales, raciones, pedidos y personal con un punto más de seguridad.',
    ...
    'how.step1.text': 'Exportar tus datos es sencillo. Todos los TPV tienen una opción de exportación, normalmente tras unos pocos clics. Si te atascas, te ayudamos.',
    'how.step2.title': 'Subida rápida y segura',
    'how.step2.text': 'Te enviamos un enlace para que compartas tu archivo de forma rápida y segura. Con nosotros tus datos se mantendrán protegidos y privados.',
    'how.step3.title': 'Accede a tu panel',
    'how.step3.text': 'Tu panel con tus resultados estará listo en un dia laborable y podrás acceder a tus previsiones de inmediato.',

    // Features Section
    'features.title': 'Previsión de demanda inteligente que se ajusta a tu restaurante',
    ...
    'features.item2.text': 'Tu previsión analiza tu histórico de ventas junto al clima para entender cómo influyen el día de la semana, la temperatura y la lluvia en la demanda de tu restaurante.',
    'features.item3.title': 'Previsión continua a 7 días',
    'features.item3.text': 'Siempre disponible para consultar las ventas esperadas de hoy y de los próximos 6 días. Se actualiza constantemente para ayudarte con pedidos, turnos y preparación.',
